        ...
        <div class="sec-body open" id="s1">
            ...
            <div class="two-col">
                <div class="field-group">
                    <div class="field-label">الاسم الأول <span class="field-required">*</span></div>
                    <input class="field-input @error('first_name') is-invalid @enderror" type="text" name="first_name" value="{{ old('first_name', $firstName) }}" required/>
                    @error('first_name') <div class="field-error">{{ $message }}</div> @enderror
                </div>
                <div class="field-group">
                    <div class="field-label">اسم العائلة <span class="field-required">*</span></div>
                    <input class="field-input @error('last_name') is-invalid @enderror" type="text" name="last_name" value="{{ old('last_name', $lastName) }}" required/>
            ...
            <div class="field-group">
                ...
                <input class="field-input @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email', $user->email) }}"/>
                @error('email') <div class="field-error">{{ $message }}</div> @enderror
            </div>
            <div class="field-group">
                <div class="field-label">رقم الهاتف الاحتياطي</div>
                <input class="field-input" type="tel" name="phone_backup" placeholder="اختياري" value="{{ old('phone_backup', '') }}"/>
            </div>
...
<form method="POST" action="{{ route('admin.settings.update-preferences') }}">
    @csrf
    @method('PUT')
    <div class="sec-card">
