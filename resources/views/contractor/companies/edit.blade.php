    ...
    <div style="background:#fff;border:0.5px solid #d0d0c8;border-radius:12px;padding:28px">
        ...
        <form method="POST" action="{{ route('contractor.companies.update', $company) }}">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:24px">
                ...
                <div>
                    <label style="display:block;font-size:14px;font-weight:600;color:#1a1c19;margin-bottom:6px">أجر الشركة (لكل عامل) *</label>
                    ...
                    <div style="display:flex;align-items:center;gap:8px">
                        <input type="number" name="contractor_rate" value="{{ old('contractor_rate', $company->contractor_rate) }}" step="0.01"
                            style="width:100%;padding:10px 12px;border:0.5px solid @error('contractor_rate') #ba1a1a @else #d0d0c8 @enderror;border-radius:8px;font-size:14px;box-sizing:border-box">
                        <span style="font-size:13px;color:#707a6c;white-space:nowrap;font-weight:500">جنيه</span>
                    </div>
                    @error('contractor_rate') <p style="color:#ba1a1a;font-size:12px;margin-top:4px">❌ {{ $message }}</p> @enderror
                </div>

                <div>
                    <label style="display:block;font-size:14px;font-weight:600;color:#1a1c19;margin-bottom:6px">أجر العامل (يومي) *</label>
